<main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
        <img src="assets/img/logo_barengkrajan.svg" class="img-fluid animated" alt="" style="max-width: 200px;">
        <h1>Selamat datang di <span>Desa Barengkrajan</span></h1>
        <p>Desa yang terletak di wilayah Kecamatan Krian, Kabupaten Sidoarjo, Provinsi Jawa Timur.</p>
        <div class="d-flex">
          <a href="https://www.youtube.com/watch?v=YkXxCavPUY0&t=1s" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Tonton Video</span></a>
        </div>
      </div>
    ...
    <section id="contact" class="contact section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>Peta Desa</h2>
            <p>Desa Barengkrajan berada di pertigaan by pass Krian, jalan utama Surabaya-Yogyakarta dan Kawasan Industri di Kecamatan Driyorejo, Kabupaten Gresik.</p>
        </div><!-- End Section Title -->

        <div class="mb-5">
            <iframe style="width: 100%; height: 400px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15827.122674653994!2d112.59594023220781!3d-7.378461101926442!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e78083cebb13f21%3A0x4a84a201c69e88d8!2sBarengkrajan%2C%20Krian%2C%20Sidoarjo%20Regency%2C%20East%20Java!5e0!3m2!1sen!2sid!4v1734811170750!5m2!1sen!2sid" frameborder="0" allowfullscreen=""></iframe>
        </div><!-- End Google Maps -->
